...
describe('PathwayCard', () => {
  ...
  describe('CSS color validation', () => {
    ...
    it('uses CSS.supports when available and accepts valid colors', () => {
      ...
      expect(screen.getByText('Bootcamp')).toHaveStyle({ backgroundColor: '#123456', color: 'white' });
    });
    ...
    it('uses CSS.supports when available and rejects invalid colors', () => {
      ...
      render(<PathwayCard {...props} pathwayType="Bootcamp" pathwayTypeBackgroundColor="not-a-color" pathwayTypeTextColor="white" />);
    ...
    it('falls back safely when CSS.supports throws', () => {
      ...
      expect(screen.getByText('Bootcamp')).not.toHaveStyle({ backgroundColor: '#123456' });
    });
  });
